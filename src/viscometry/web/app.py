...
from viscometry.paths import EXPERIMENT_HISTORY_PATH, WEB_STATIC, WEB_TEMPLATES
...
class ViscometryWebInterface:
    ...
    def create_directories(self):
        ...
        os.makedirs(WEB_STATIC / "images", exist_ok=True)
    ...
    def sync_experiment_review_cells_from_run(
        ...
        from viscometry.run.export import count_z_levels
    ...
    def _build_experiment_history_entry_from_review(
        ...
        if not saved_cell_ids:
            return None
        from viscometry.run.export import extract_latest_points_from_all_data
