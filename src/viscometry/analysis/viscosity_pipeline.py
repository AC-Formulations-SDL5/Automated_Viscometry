"""Offline batch viscosity pipeline from rotational-drag CSV exports."""
...
from viscometry.io.csv_text import resolve_existing_csv_path
...
def run_viscosity_pipeline(
    ...
    7) Plot fitting overlays and prediction accuracy for both methods
    """
    data_path = resolve_existing_csv_path(csv_path, search_dirs=_DEFAULT_SEARCH_DIRS)
