...
from viscometry.discovery.torque_ladder import (
    LADDER_TARGETS,
    fit_n_probe,
    is_newtonian_probe,
...
from viscometry.discovery.types import (
    DiscoveryConfig,
...
from viscometry.paths import calibration_file

_CONFIG_PATH = calibration_file("discovery_bulk_calibration.json")
